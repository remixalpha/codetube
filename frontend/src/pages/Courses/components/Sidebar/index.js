...
<div className="flex flex-col items-center justify-center mt-[2rem] gap-4 " >
      ...
      {/*Courses*/}
      <div className="w-4/5 h-15  flex items-center justify-start gap-3 p-5 cursor-pointer rounded-[2rem] bg-lightPrimary hover:scale-105 ">
        <lord-icon
          className="cursor-pointer"
