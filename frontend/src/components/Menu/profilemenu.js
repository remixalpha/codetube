...
const ProfileMenu = () => {
  ...
  return (
    <Card extra="items-center h-[25rem] w-[16rem] mt-1 -ml-4 mr-5 p-[16px] ">
      <div className="menu flex flex-col items-center p-5 -mt-7">
        <ul className="mr-2  ">

          <li className="mb-2 flex w-[14rem] items-center rounded-[20px] bg-white p-3 hover:bg-lightPrimary " onClick={ProfileButtonClick}>
          ...
          <li className="mb-2 flex w-full items-center rounded-[20px] bg-white p-4 hover:bg-lightPrimary ">
